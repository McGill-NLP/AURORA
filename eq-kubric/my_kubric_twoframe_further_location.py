...
while not check_ok(obj, obj.position, SPAWN_REGION_OBJ):
    trails += 1
    obj.position = get_new_pos(obj.bounds, obj.scale, ref_location2, obj.position, ref_obj_z_up, ref_object, rng)
